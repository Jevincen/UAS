...
public class util {
     ...
     */
    public static void updateAll ( ArrayList <Mobil> mobils,ArrayList <TransaksiPeminjaman> pinjams, ArrayList <TransaksiPengembalian> kembalis, ArrayList <Pelanggan> pelanggans, ArrayList<Angkot> motors) throws FileNotFoundException, IOException, ParseException{
